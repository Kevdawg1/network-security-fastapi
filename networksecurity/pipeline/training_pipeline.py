...
class TrainingPipeline: 
    ...
    def start_model_trainer(self, data_transformation_artifact: DataTransformationArtifact):
        try:
            ...
            logging.info(f"Starting model trainer")
    ...
    def sync_artifact_dir_to_s3(self):
        try:
            ...
            logging.info(f"Syncing artifact directory: {self.training_pipeline_config.artifact_dir} to {aws_bucket_url}")
    ...
    def sync_saved_model_dir_to_s3(self):
        try:
            ...
            logging.info(f"Syncing saved model directory: {self.training_pipeline_config.model_dir} to {aws_bucket_url}")
